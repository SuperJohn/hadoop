optsoa_tracking = load '../data/persona/tracking_logs.gz' using PigStorage('\u0001') as (
...
persona_1 = load '../data/persona/persona_data.gz.parquet' using parquet.pig.ParquetLoader();
...
rmf ../data/persona/persona_local_test ;
store control_accept_count into '../data/persona/persona_local_test' USING PigStorage('\t')  ;
